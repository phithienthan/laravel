...
<body>
    <header class="main-header" >
        ...
        <!-- Logo -->
        <a href="<?php echo e(route('home')); ?>" class="logo white" style="color: white">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse white" style="color: white">
                ...
                <ul class="nav navbar-nav navbar-right" style="margin-right: 85px!important;">
                    ...
                    <li ><a href="<?php echo e(route('login')); ?>" class="white">Login</a></li>
                    <li><a href="<?php echo e(route('register')); ?>" class="white">Register</a></li>
                    <?php else: ?>
                    <li class="dropdown">
